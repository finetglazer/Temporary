            ...
            <>
                ...
                <div className="body">
                    <div className="portfolio-info">
                        ...
                        <div className="prop">
                            <img src="../../assets/stocks.png" alt="account icon" />
                            ...
                            <div className="total-value-info">
                                ...
                                {totalValue - initialTotalValue < 0 && (
                                    <div className="gain-percentage-wrapper">
                                        <img src="../../assets/arrow-down.png" alt="direction icon" style={{width: 15, height: 15, marginRight: 3}}/>
                                ...
                                {totalValue - initialTotalValue >= 0 && (
                                    <div className="gain-percentage-wrapper" style={{backgroundColor: "#054d05"}}>
                                        <img src="../../assets/up-arrow.png" alt="direction icon" style={{width: 15, height: 15, marginRight: 3}}/>
                                    ...
                                    <div className="comparison-object">
                                        ...
                                        {(symbolChanges[symbol] ?? {percentageChange: 0}).percentageChange >= 0 && (
                                            <>
                                                ...
                                                <div className="total-gain-percentage">
                                                    <img src="../../assets/up-arrow.png" alt="direction icon" style={{width: 12, height: 12, marginRight: 3}}/>
                                        ...
                                        {(symbolChanges[symbol] ?? {percentageChange: 0}).percentageChange < 0 && (
                                            <>
                                                ...
                                                <div className="total-gain-percentage" style={{backgroundColor: "#670202"}}>
                                                    <img src="../../assets/arrow-down.png" alt="direction icon" style={{
                                                        width: 15,
                                                        height: 15,
                                                        marginRight: 3
                                                    }}/>
                                        ...
                                        <div className="remove-btn-wrapper">
                                            <button className="remove-btn" onClick={() => {
                                                ...
                                                <img src="../../assets/x-white.png" alt="remove icon" />
                                            </button>
                                        </div>
                                    </div>
                                ))}
                                    ...
                                    <div className="comparison-objects-list-container">
                                        <div className="search-bar">
                                            ...
                                            <button className="close-btn" onClick={() => {
                                                ...
                                                <img src="../../assets/x-white.png" alt="close icon"/>
                                            </button>
                                        </div>
                                              ...
                                              style={{backgroundColor: sortedSymbolChanges[Object.keys(sortedSymbolChanges)[Object.keys(sortedSymbolChanges).length - 1]].valueChange < 0 ? "#670202" : "#054d05"}}>
                                                ...
                                                <div className="percentage">
                                                    {sortedSymbolChanges[Object.keys(sortedSymbolChanges)[Object.keys(sortedSymbolChanges).length - 1]].valueChange < 0 && (
                                                        <>
                                                            <img src="../../assets/arrow-down.png" alt="direction icon"/>
                                                    ...
                                                    {sortedSymbolChanges[Object.keys(sortedSymbolChanges)[Object.keys(sortedSymbolChanges).length - 1]].valueChange >= 0 && (
                                                        <>
                                                            <img src="../../assets/up-arrow.png" alt="direction icon"
                                                                 style={{width: 15, height: 15, marginRight: 3}}/>
