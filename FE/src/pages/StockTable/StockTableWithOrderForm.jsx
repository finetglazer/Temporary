...
import StockTable from './StockeTable.jsx';
import BuyOrderForm from './BuyOrderForm.jsx';
import OrderProgressTracker from './OrderProgressTracker.jsx';
import OrderNotificationModal from './OrderNotificationModal.jsx';
import LoadingOverlay from './LoadingOverlay.jsx';
import {submitOrder, getOrderStatus, cancelOrder} from '../../services/orderService.js';
...
const StockTableWithOrderForm = () => {
    ...
    // Replace this function in StockTableWithOrderForm.jsx
    const handleViewPortfolio = () => {
        // Navigate to portfolio page with userId in the path
        navigate(`/${userId}/portfolio`);
    };
